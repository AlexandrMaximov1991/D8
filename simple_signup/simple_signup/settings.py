...
SECRET_KEY = 'django-insecure-47rkc#2xb7i%v7zkbk6h$=5adqro&t%5$nn_tacd2a5gs7r#_#'
...
ADMINS = [
    ('Alexandr', 'maximovyaa@yandex.ru'),
]
SERVER_EMAIL = 'maximovyaa@yandex.ru'  # адрес отправителя

# DEFAULT_FROM_EMAIL = 'maximovyaa@yandex.ru'  # здесь указываем уже свою ПОЛНУЮ почту, с которой будут отправляться письма
